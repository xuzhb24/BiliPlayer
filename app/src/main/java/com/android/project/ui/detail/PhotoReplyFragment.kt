 ...
 * Desc:图片详情页-评论
 */
class PhotoReplyFragment : BaseListFragment<ReplyBean, LayoutListBinding, VideoReplyViewModel>() {

    companion object {
        private const val TAG = "PhotoReplyFragment"
        private const val EXTRA_ID = "EXTRA_ID"

        fun newInstance(id: Int) = PhotoReplyFragment().apply {
    ...
    override fun handleView(savedInstanceState: Bundle?) {
        mLoadingLayout?.let {
            ...
            LayoutParamsUtil.setPaddingTop(it.getRootLayout(), SizeUtil.dp2pxInt(100f))
        }
    }
